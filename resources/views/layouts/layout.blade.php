    ...
    <div class="container py-2">
      <div class="row py-4 pb-0 pb-sm-4 align-items-center ">
        ...
        <div class="col-sm-4 col-lg-3 text-center text-sm-start">
          <div class="main-logo">
            <a href="index.html">
              <img src="{{asset('images/logo-27.png')}}" alt="logo" class="img-fluid">
            </a>
          </div>
        </div>

        <div class="col-sm-6 offset-sm-2 offset-md-0 col-lg-7 d-none d-lg-block">
        ...
        <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
          ...
          <div class="offcanvas-body justify-content-between ">
            ...
            <ul class="navbar-nav menu-list list-unstyled d-flex gap-md-3 mb-0">
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="pages">
                  <li><a href="index.html" class="dropdown-item">2 piece</a></li>
                  <li><a href="index.html" class="dropdown-item">3 piece</a></li>
                  <li><a href="index.html" class="dropdown-item">Western</a></li>
                  <li><a href="index.html" class="dropdown-item">Eastern</a></li>
            ...
            <div class="d-none d-lg-flex align-items-end ">
              <ul class="d-flex justify-content-end list-unstyled m-0">
                <li>
                  <a href="{{route('user.login')}}" class="mx-3">
                    <iconify-icon icon="healthicons:person" class="fs-4"></iconify-icon>
                  </a>
                </li>
                <li>
                  <a href="{{route('user.wishlist')}}" class="mx-3">
                    <iconify-icon icon="mdi:heart" class="fs-4"></iconify-icon>
                  </a>
                </li>
